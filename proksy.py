...
if __name__ == "__main__":
    main()  
    #koda pc bilgileri ekle#
    #Koda PC bilgileri eklemek için aşağıdaki değişiklikleri yapabiliriz. Bu değişiklikler, program başladığında sistem bilgilerini gösterecek ve log dosyasına kaydedecek.
 #İlk olarak, print_banner() fonksiyonunu genişletelim ve sistem bilgilerini gösterelim. Ayrıca loglama sistemine de sistem bilgilerini ekleyelim.#
